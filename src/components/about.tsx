      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="flex flex-col gap-6 text-[clamp(14px,2vw,18px)] text-text-secondary leading-relaxed"
          >
            <p>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="font-space-grotesk text-4xl font-bold text-text-primary mb-2 group-hover:text-accent transition-colors">
                  <Counter from={1} to={50} duration={4} suffix="+" />
                </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="font-space-grotesk text-4xl font-bold text-text-primary mb-2 group-hover:text-accent transition-colors">
                  <Counter from={1} to={48} duration={4} suffix="hr" />
                </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="font-space-grotesk text-4xl font-bold text-text-primary mb-2 group-hover:text-accent transition-colors">
                  <Counter from={1} to={100} duration={4} suffix="%" />
                </div>
